...
logger.info("STARTED CUSTOM_SOCKET")

class Sockets:

	def __init__(self, src_host, src_port, dest_host = None, dest_port = None, 
	broadcast_host = None):
	...
	def create_socket(self, tcp = None, udp = None, tcp_timeout = None, udp_timeout = None, tcp_listen = None):
		if tcp:
